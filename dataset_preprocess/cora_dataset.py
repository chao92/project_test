...
class CoraDataset(InMemoryDataset):
    ...
    url = "https://github.com/chao92/posionAttack/tree/dig/benchmarks/agraph/datasets/cora/raw/{}"
    ...
    def __init__(self, root, name, transform=None, pre_transform=None, added_new_nodes=None):
    ...
    def preprocessing_cora_data(self):
        ...
        if self.added_node_num:
            ...
            r, c = 0, 0
            new_adj_matrix[r:r+adj_matrix.shape[0], c:c+adj_matrix.shape[1]] += adj_matrix
