...
def build_args():
    ...
    parser.add_argument('--attack_graph', type=bool, default=True, help='global attack')
...
if __name__ == '__main__':
    ...
    baseline_model_ckpt_fold = osp.join('checkpoints', data_name, 'GCN_2l')
    ...
    # check baseline output for sepcific node
    model.eval()
    ...
    with torch.no_grad():
        ...
        cols = ["test_ID", "predict_class", "predict scores"]
        success = None
        # y is from [0-6]
        tmp_list = []
        ...
        path = osp.join('./results', data_name, 'baseline')
